                ...
                await resend.emails.send({
                    ...
                    html: `
                        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                            <h1 style="color: #0d9488;">Nouveau Projet à Saisir</h1>
                            ...
                            <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; border: 1px solid #e2e8f0; margin: 20px 0;">
                                ...
                                <ul style="list-style: none; padding: 0;">
                                    ...
                                    ${meta.age_beneficiary ? `<li style="margin-bottom: 10px;">👤 <strong>Âge du bénéficiaire :</strong> ${meta.age_beneficiary}</li>` : ''}
                                    ${meta.timeframe ? `<li style="margin-bottom: 10px;">📅 <strong>Délai :</strong> ${meta.timeframe}</li>` : ''}
                                </ul>
                            </div>
...
export async function deliverUnlockedLead(leadId: string, partnerId: string) {
    ...
    if (resend && partner.email) {
        ...
        await resend.emails.send({
            ...
            html: `
                <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                    <div style="background-color: #0d9488; color: white; padding: 30px; border-radius: 8px 8px 0 0; text-align: center;">
                    ...
                    <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 8px 8px; border: 1px solid #e2e8f0; border-top: none;">
                        ...
                        <ul style="list-style: none; padding: 0; font-size: 16px;">
                            ...
                            <li style="margin-bottom: 12px;"><strong>Email :</strong> <a href="mailto:${lead.email}" style="color: #0d9488;">${lead.email}</a></li>
                            <li style="margin-bottom: 12px;"><strong>Téléphone :</strong> <a href="tel:${lead.phone}" style="color: #0d9488;">${lead.phone}</a></li>
                        ...
                        <ul style="list-style: none; padding: 0; font-size: 14px; color: #475569;">
                            ...
                            ${meta.age_beneficiary ? `<li style="margin-bottom: 8px;"><strong>Âge du bénéficiaire :</strong> ${meta.age_beneficiary}</li>` : ''}
                            ${meta.timeframe ? `<li style="margin-bottom: 8px;"><strong>Délai :</strong> ${meta.timeframe}</li>` : ''}
                            ${lead.notes ? `<li style="margin-top: 15px; padding: 10px; background: #f8fafc; border-left: 4px solid #0d9488;"><strong>Note Admin :</strong> ${lead.notes}</li>` : ''}
                        </ul>
