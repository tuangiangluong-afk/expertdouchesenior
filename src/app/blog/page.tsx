            ...
            <div className="container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-neutral-900 mb-6">
                        Le Blog de la Douche Senior & PMR
                    </h1>
                    <p className="text-xl text-neutral-600">
                        Guides, actualités et conseils d'experts pour réussir l'aménagement de votre salle de bain.
                    </p>
                </div>
                        ...
                        <Link key={post.id} href={`/blog/${post.slug}`} className="group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-neutral-100 h-full">
                             <div className="relative h-56 w-full overflow-hidden">
                                {post.featured_image_url ? (
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-teal-600 to-teal-400" />
                                )}
                                {post.category && (
                                    <span className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm text-teal-900 text-xs font-bold px-3 py-1 rounded-full border border-teal-100">
                                        {post.category.name}
                                    </span>
                                )}
                             </div>
                             <div className="p-6 flex flex-col flex-grow">
                                ...
                                <h2 className="text-xl font-bold text-neutral-900 mb-3 group-hover:text-teal-600 transition-colors line-clamp-2">
                                    {post.title}
                                </h2>
