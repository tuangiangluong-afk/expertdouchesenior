...
import { CheckCircle, Phone, Wrench, FileText, Gift, ArrowRight, Download, Shield } from "lucide-react";
...
export async function generateMetadata({
    ...
    return {
        ...
        alternates: {
            canonical: `https://${config?.domain || "expertdouchesenior.com"}/success`,
        },
    };
}
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6">
                        ...
                        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-1 shadow-lg text-white overflow-hidden relative">
                            ...
                            <div className="p-6 md:p-8 relative z-10">
                                ...
                                <Link
                                    href={`/${domain}/guides/ma-prime-adapt-mode-d-emploi`}
