            ...
            <main className="container mx-auto max-w-3xl px-4 py-12 lg:py-20 mb-20">
                ...
                <div className="prose prose-neutral prose-lg max-w-none">
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <p>
                            Le Site a pour objet de fournir une plateforme de mise en relation et d'obtention de devis pour l'installation de douches sécurisées, de baignoires à porte et d'équipements d'adaptation de salle de bain pour personnes à mobilité réduite (PMR) sur la commune de <strong>{city.city}</strong> et ses environs ({city.neighborhoods.join(", ") || "agglomération"}).
                        </p>
                        <p>
                            Les services d'installation sont assurés par des artisans plombiers indépendants ou des sociétés spécialisées, titulaires de certifications ou labels d'accessibilité (tels que Handibat ou Silverbat) et des assurances obligatoires (notamment garantie décennale).
                        </p>
                    </div>
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <p>
                            Les informations collectées via le module de demande de devis (nom, téléphone, adresse) sont nécessaires au traitement de votre demande d&apos;installation. Elles sont transmises exclusivement aux installateurs partenaires spécialisés dans l'aménagement de salles de bain PMR et de douches sécurisées.
                        </p>
                        <p>
