...
export default async function CityPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <div className="min-h-screen font-sans text-slate-900 bg-white">
            ...
            <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24">
                <div className="container mx-auto px-4">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <div className="inline-flex items-center gap-2 bg-teal-50 text-teal-600 px-4 py-2 rounded-full text-sm font-bold mb-6">
                                <CheckCircle size={16} />
                                {pseo.hero_badge}
                            </div>
                            <h1
                                className="text-4xl lg:text-6xl font-extrabold text-slate-900 mb-6 leading-tight"
                                dangerouslySetInnerHTML={{ __html: pseo.hero_title.replace(/text-blue-500/g, "text-teal-600") }}
                            />
                            <div
                                className="text-lg text-slate-600 mb-8 leading-relaxed prose prose-lg prose-teal"
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a
                                    href="#simulateur"
                                    className="bg-teal-600 text-white px-8 py-4 rounded-xl font-bold text-center hover:bg-teal-700 transition"
                                >
                                    {pseo.cta_primary}
                                </a>
                                <a
                        ...
                        <div className="relative h-[400px] lg:h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                            <Image
                                src={site.heroImage}
                                alt={`Installation douche senior ${site.city}`}
                                fill
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto bg-white p-8 rounded-3xl shadow-xl">
                        <div className="text-center mb-10">
                            <h2 className="text-3xl font-bold text-slate-900 mb-4">Votre simulation d&apos;aides en 2 min</h2>
                            <p className="text-slate-600">Estimation immédiate de vos subventions et coût d&apos;adaptation</p>
                        </div>
                        <LeadForm
                            city={site.city}
            ...
            <Reviews site={site} themeColor="teal" />
