...
const HOME_FIELDS = [
    { key: "hero_title", label: "Titre Hero (H1)", type: "text", placeholder: "Installation Douche Senior à..." },
    { key: "hero_subtitle", label: "Sous-titre Hero", type: "textarea", placeholder: "Remplacement de baignoire par une douche sécurisée PMR..." },
    { key: "cta_button", label: "Texte CTA Button", type: "text", placeholder: "Demander un devis gratuit" },
    { key: "about_title", label: "Titre 'À Propos'", type: "text", placeholder: "Pourquoi choisir Expert Douche Senior ?" },
    { key: "about_text", label: "Texte 'À Propos'", type: "textarea", placeholder: "Nous installons des douches sécurisées PMR en 48h..." },
];
