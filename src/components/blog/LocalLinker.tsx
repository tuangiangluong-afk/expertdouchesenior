        ...
        <div className="bg-slate-900 text-white p-6 rounded-2xl shadow-xl ring-1 ring-white/10 relative z-50">
            <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                    ...
                    <p className="text-teal-200 text-xs">Trouvez votre expert de proximité</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSearch} className="mb-4 relative">
                <div className="relative">
                    <input
                        ...
                        className="w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 pl-10 text-sm focus:ring-2 focus:ring-teal-500 outline-none transition placeholder:text-slate-500 text-white"
                        autoComplete="off"
                    />
                    ...
                    <button
                        ...
                        className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 bg-teal-600 rounded-lg hover:bg-teal-500 disabled:opacity-50 transition text-white"
                    >
                        {status === 'loading' ? (
                            ...
                            {filteredSuggestions.map((s) => (
                                <li key={s.slug}>
                                    <button
                                        ...
                                        className="w-full text-left px-4 py-3 text-sm text-slate-700 hover:bg-teal-50 hover:text-teal-700 transition flex items-center justify-between group"
                                    >
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-sm font-medium text-green-100 mb-2">
                                Bonne nouvelle ! Nous avons un installateur de douche senior partenaire à <span className="text-white font-bold">{result.city}</span>.
                            </p>
                            <Link
                                href={result.url}
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-xs text-slate-300 mb-2">
                                Pas d'antenne locale dédiée pour cette zone, mais notre réseau national couvre toute la France.
                            </p>
                            <Link
                                href="/#simulateur"
                                className="text-xs font-bold text-teal-400 hover:text-teal-300 underline decoration-teal-400/30"
                            >
